  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#111111] via-[#111111]/80 to-[#0a0a0a] z-0" />
        <AnimatedCards />
        ...
        <div className="relative z-10 text-center max-w-5xl px-6 pt-20 pointer-events-none">
          ...
          >
            Enterprise Cloud <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/80 to-white/40">Infrastructure</span>
          </motion.h1>
          <motion.p 
          ...
          >
            <Link href="/register">
              <Button size="lg" className="rounded-full px-10 text-lg h-14 bg-white text-black hover:bg-gray-200 transition-all hover:scale-105">Start Now</Button>
            </Link>
            <Link href="/about">
              <Button size="lg" variant="outline" className="rounded-full px-10 text-lg h-14 border-white/20 hover:bg-white/10 hover:border-white/40 transition-all">Pricing</Button>
            </Link>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 border-y border-white/5 bg-[#0a0a0a] relative z-20">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            >
              <div className="text-5xl md:text-6xl font-display font-bold mb-4 tracking-tighter">{stat.value}</div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              className="p-10 rounded-3xl bg-[#161616] border border-white/5 hover:border-white/20 transition-all duration-300 cursor-pointer group relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-white/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              <prod.icon className="w-12 h-12 mb-8 text-white/40 group-hover:text-white transition-colors duration-300" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className={`p-10 rounded-3xl relative border ${tier.popular ? 'bg-white/5 border-white/20 scale-105 shadow-2xl' : 'bg-[#161616] border-white/5'}`}>
                {tier.popular && <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white text-black text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest">Most Popular</div>}
                ...
                <ul className="space-y-4 mb-10">
                  {tier.features.map((f, j) => (
                    <li key={j} className="flex items-center text-sm">
                      <div className="w-1.5 h-1.5 rounded-full bg-white mr-3 opacity-60" />
                      {f}
                    </li>
                  ))}
                </ul>
